...
import '../services/diary_controller.dart'; // <-- Import your Diary model
...
class DiaryDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xFFEADFD8), // Soft cream background
      appBar: AppBar(
        leading: IconButton(
        ...
        backgroundColor: const Color(0xFFF5F3EF), // Purple shade
